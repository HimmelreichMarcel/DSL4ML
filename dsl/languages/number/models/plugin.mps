...
<model ref="r:006a4100-6a66-4bea-a3eb-425226bb5d4d(number.plugin)">
  ...
  <node concept="2N9Ry$" id="5j$SRt4f9dA">
    <property role="bGGJC" value="number" />
    <property role="TrG5h" value="FeatureConfig.number" />
    <property role="NrALT" value="core.featuresEditing.number" />
