...
<model ref="r:82c6d4a3-e290-401d-a99e-a9248ada8725(list.plugin)">
  ...
  <node concept="2N9Ry$" id="5j$SRt4f9b4">
    <property role="bGGJC" value="list" />
    <property role="TrG5h" value="FeatureConfig.list" />
    <property role="NrALT" value="core.featuresEditing.list" />
