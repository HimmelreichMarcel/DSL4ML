...
<model ref="r:b25faf64-77da-44d3-b10c-f3abf6d4e3c6(number.plugin)">
  ...
  <node concept="2N9Ry$" id="6183EJ2ddMK">
    <property role="bGGJC" value="numberFeatureOps" />
    <property role="TrG5h" value="FeatureConfig.numberFeatureOps" />
    <property role="NrALT" value="core.featuresetEditing.numberFeatureOps" />
