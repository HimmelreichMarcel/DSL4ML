...
<model ref="r:61fb9bfe-00e1-43ed-b604-c4ebc0fcebb0(string.constraints)">
  ...
  <node concept="1M2fIO" id="yww_xQrEDy">
    <ref role="1M2myG" to="ijxw:yww_xQrD1r" resolve="IStringOp" />
    <node concept="9S07l" id="yww_xQrEDz" role="9Vyp8">
      <node concept="3clFbS" id="yww_xQrED$" role="2VODD2">
