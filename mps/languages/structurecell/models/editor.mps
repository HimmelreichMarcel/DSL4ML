...
<model ref="r:46c5670a-9855-4b21-ab40-449b231aabfa(structurecell.editor)">
  ...
  <imports>
    ...
    <import index="f0y8" ref="r:0cea681c-b7e9-47ab-b476-138cbe3583ab(structurecell.structure)" implicit="true" />
  </imports>
  <registry>
  ...
  <node concept="24kQdi" id="7AjS6YE$nte">
    <ref role="1XX52x" to="f0y8:7AjS6YE$8rm" resolve="CellModel_SectionCell" />
    <node concept="3EZMnI" id="7AjS6YE$nuf" role="2wV5jI">
      ...
      <node concept="3F1sOY" id="7AjS6YE$nuy" role="3EZMnx">
        <ref role="1NtTu8" to="f0y8:7AjS6YE$mxc" resolve="child" />
      </node>
  ...
  <node concept="V5hpn" id="7AjS6YEz02l">
    <property role="TrG5h" value="SectionCellStyleAttributes" />
