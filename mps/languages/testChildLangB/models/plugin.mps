...
<model ref="r:611b903b-5fb4-4106-b2e9-1ee2f9860196(testChildLangB.plugin)">
  ...
  <node concept="2N9Ry$" id="4x6uVBKydST">
    <property role="bGGJC" value="subFeatureB" />
    <property role="TrG5h" value="FeatureConfig.subFeatureB" />
    <property role="NrALT" value="core.testFeature.subFeatureB" />
